...
<body>
	...
	<h3>applicationBean1.data1 : ${requestScope.applicationBean3.data5 }</h3>
	<h3>applicationBean1.data2 : ${requestScope.applicationBean3.data6 }</h3>
	
	<h3>applicationBean1.data1 : ${requestScope.applicationBean4.data7 }</h3>
	<h3>applicationBean1.data2 : ${requestScope.applicationBean4.data8 }</h3>
</body>
</html>